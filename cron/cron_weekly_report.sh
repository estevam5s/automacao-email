#!/usr/bin/env bash
# Cron job 5 — relatório semanal
# Schedule: 0 3 * * 1  (job: email-cron-5-weekly-report)
...
echo "[] Executando email-cron-5-weekly-report..."

curl -s -X POST "/rest/v1/table_cron"   -H "apikey: "   -H "Authorization: Bearer "   -H "Content-Type: application/json"   -H "Prefer: return=minimal"   -d '{"num": 5}' && echo " OK" || echo " ERRO"
